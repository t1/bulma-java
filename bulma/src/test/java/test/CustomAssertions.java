...
public class CustomAssertions extends BDDAssertions {
    ...
    public static class RenderableAssert {
        ...
        /// Also renders the renderable into the file `target.all-tests.html`,
        ...
        /// Like #rendersAs, but it _doesn't_ render it into the `all-tests.html`.
        /// This is necessary, e.g., for tests that render a `html` tag.
