...
class SelectTest {
    ...
    @Test void shouldRenderMultiSelect() {
    ...
    @Test void shouldRenderSelectWithLeftIcon() {
        var select = field().containsControl(select(null)
    ...
    @Test void shouldRenderSmallSelectWithLeftIcon() {
        var select = field().containsControl(select(null).is(SMALL)
                        .option(null, "Country").selected()
                        .option(null, "Select dropdown")
                        .option(null, "With options"))
                .iconLeft("globe");
    ...
    @Test void shouldRenderMediumSelectWithLeftIcon() {
        var select = field().containsControl(select(null).is(MEDIUM)
                        .option(null, "Country").selected()
                        .option(null, "Select dropdown")
                        .option(null, "With options"))
    ...
    @Test void shouldRenderLargeSelectWithLeftIcon() {
        var select = field().containsControl(select(null).is(LARGE)
                        .option(null, "Country").selected()
                        .option(null, "Select dropdown")
                        .option(null, "With options"))
